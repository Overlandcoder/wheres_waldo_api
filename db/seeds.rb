...
space = Map.create(name: "space")
space.characters.create(name: "waldo", position: [0.5133, 0.5191, 0.6193, 0.6461])
space.characters.create(name: "wizard", position: [0.8872, 0.8947, 0.5628, 0.5895])
space.characters.create(name: "odlaw", position: [0.1771, 0.1846, 0.6944, 0.7160])
space.characters.create(name: "wilma", position: [0.4022, 0.4086, 0.4949, 0.5195])
